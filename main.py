...
model_output_path = r"C:\Users\sahar\Desktop\dbt-starter\models"

tables_file = pd.ExcelFile(r"C:\Users\sahar\Desktop\dbt-starter\tables.xlsx")
tables_dfs = {sheet_name: tables_file.parse(sheet_name) for sheet_name in tables_file.sheet_names}

columns_file = pd.ExcelFile(r"C:\Users\sahar\Desktop\dbt-starter\columns.xlsx")
